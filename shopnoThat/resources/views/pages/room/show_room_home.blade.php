...
<div class="features_items"><!--features_items-->
						@foreach($room_name as $key => $room_name)
						<h2 class="title text-center">Sản phẩm của {{$room_name->room_name}} </h2>
						@endforeach
						@foreach($room_by_id as $key => $pro)
                        <div class="col-sm-4">
					...
					<ul class="pagination pagination-sm m-t-none m-b-none">
						<span>{!!$room_by_id->links("pagination::bootstrap-4")!!}</span>
					</ul>
					<!--features_items-->
